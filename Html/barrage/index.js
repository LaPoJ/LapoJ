  ...
  renderBarrage(){
    ...
    this.barrages.forEach(barrage => {
      ...
      if(!barrage.flag && time >= barrage.time) {
        ...
        // 弹幕需要从右往左渲染，只需要将X轴坐标减去当前弹幕的speed即可
        barrage.x -= barrage.speed;
        barrage.render();
        // 如果弹幕的X轴的坐标小于自身的宽度，代表渲染结束
...
// 设置video的play事件来调用canvasBarrage 里面的redner
